...
/**
 * Konstruktor f�r nicht-gef�lltes Rechteck.
 * @param x1 x-Koordinate eines Eckpunktes
 * @param y1 y-Koordinate eines Eckpunktes
 * @param x2 x-Koordinate des gegen�berliegenden Eckpunktes
 * @param y2 y-Koordinate des gegen�berliegenden Eckpunktes
 */
