...
public class PreparedSpatialStatement implements PreparedStatement {
     ...
     * @throws SQLException if a database access, geometry or adapter error occurs
     */
    ...
    public void setNClob(int a, java.io.Reader r){}

    public void setBlob(int a, java.io.InputStream r){}
}
