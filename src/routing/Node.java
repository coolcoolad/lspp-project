...
/**
 * F�gt eine neue Kante dem Knoten zu.
...
/**
 * Gibt die erste Kante des Knotens zur�ck.
 * Existiert keine Kante, wird null zur�ckgegeben.
 * @return erste Kante
 */
...
/**
 * Gibt die ID des Knotens zur�ck.
...
/**
 * Gibt die n�chste Kante des Knotens zur�ck, nachdem zuvor getFirstEdge
 * und ggf. darauffolgend getNextEdge aufgerufen worden waren.
 * Existiert n�chste Kante, wird null zur�ckgegeben.
 * @return n�chste Kante
 */
...
/**
 * Gibt die Anzahl der anliegenden Kanten zur�ck.
 * @return int
 */
